#ifndef _SOAP_DESCRIPTOR_HPP
#define _SOAP_DESCRIPTOR_HPP
#include "python.hpp"
#include "types.hpp"
...
namespace espressopp {
  namespace soap {
    ...
    class Descriptor : public SystemAccess {
    public:
      /** Descriptor can be int, real, scalar or vector */
      enum result_types {old_format=-1, none=0, real_scalar=1, int_scalar=2, real_vector=3, int_vector=4};
      Descriptor(shared_ptr< System > system) : SystemAccess(system) {result_type=old_format; };
      virtual ~Descriptor() {};
